...
impl Date {
    ...
    ///
    /// ```rust
    /// # use ai_time::{Date, ext::NumericalStdDuration};
    /// # use ai_time_macros::date;
...
impl Date {
    ...
    /// ```rust
    /// # use ai_time::Date;
    /// # use ai_time_macros::{date, format_description};
